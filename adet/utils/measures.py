...
#                         default="/home/ubuntu/User/lichen/pythonProject/OSFormer_update/configs/CIS_R50.yaml",
...
#     stat_dict = torch.load('/home/ubuntu/User/lichen/pythonProject/OSFormer_update/output12/model_final.pth')
#     model.load_state_dict(stat_dict['model'])
#     measure_model(model, [{'image': torch.zeros(( 3, 200, 200)), 'height': 160, 'width': 160}])
